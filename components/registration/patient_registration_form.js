  ...
  return (
    <div className="flex justify-center align-middle p-10 bg-gradient-to-r  from-teal-200 to-cyan-200 mb-20 mt-10 lg:mx-40">
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500 border-b-2"
              ...
              <div className={styles.inputBox}>
                <label className=" text-2xl inline-flex items-center">
                ...
                <input
                  ...
                  value="male"
                />
                <label className="ml-2 text-xl inline-flex items-center mr-4">
                  Male
                </label>
                <input
                  className="form-radio"
                  ...
                  value="fmale"
                />
                <label className="ml-2 text-xl inline-flex items-center">
                  Female
                </label>
              </div>
            </div>
