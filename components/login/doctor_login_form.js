...
function DoctorLoginForm(params) {
  return (
    <div className=" flex justify-center align-middle font-sans py-10 px-1  md:p-10 bg-gradient-to-r  from-teal-200 to-cyan-200 mb-20 mt-10 lg:mx-40 ">
